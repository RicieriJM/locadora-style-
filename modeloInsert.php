...
echo form_open('modelo/insert', '', $styleLabels);

echo form_label('Digite o desconto: ', '', $styleLabels);
echo form_input('TB_MODELO_DESC', '', $styleInputs);

echo form_label('Digite a observação: ', '', $styleLabels);
echo form_input('TB_MODELO_OBS', '', $styleInputs);

echo form_label('Digite a data: ', '', $styleLabels);
echo form_input('TB_MODELO_DATA', '', $styleInputs);
